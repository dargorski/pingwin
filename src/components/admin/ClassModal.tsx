    ...
    return (
        <div className="modal-backdrop">
            <div className="modal">
                ...
                <input placeholder="Tytuł (opcjonalny)" value={title} onChange={(e) => setTitle(e.target.value)} />

                <input type="datetime-local" value={startsAt} onChange={(e) => setStartsAt(e.target.value)} />

                <input type="number" placeholder="Pojemność" value={capacity} onChange={(e) => setCapacity(Number(e.target.value))} />

                <input type="number" placeholder="Cena (opcjonalna)" value={price} onChange={(e) => setPrice(e.target.value)} />
